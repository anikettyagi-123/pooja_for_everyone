...
class ChangeLanguage extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_Us': {
          ...
          'Arti': 'Arti',
          'Katha': 'Katha',
          'Basant panchami (Wed, 14 Feb, 2024)':
              'Basant panchami (Wed, 14 Feb, 2024)',
          'Shivratri (Fri, 8 Mar, 2024)': 'Shivratri (Fri, 8 Mar, 2024)',
          'Hanuman jayanti (Tue, 23 Apr, 2024)':
              'Hanuman jayanti (Tue, 23 Apr, 2024)',
          'Nag panchami (Fri, 9 Aug, 2024)': 'Nag panchami (Fri, 9 Aug, 2024)',
          'Rakhsha bandhan (Mon, 19 Aug, 2024)':
              'Rakhsha bandhan (Mon, 19 Aug, 2024)',
          'Ganesh chaturthi (Sat, 7 Sept, 2024)':
              'Ganesh chaturthi (Sat, 7 Sept, 2024)',
          'Dussehra (Sat, 12 Oct, 2024)': 'Dussehra (Sat, 12 Oct, 2024)',
          'Karva chauth (Sun, 20 Oct, 2024)':
              'Karva chauth (Sun, 20 Oct, 2024)',
          'Ahoi Ashtami (Thu, 24 Oct, 2024)':
              'Ahoi Ashtami (Thu, 24 Oct, 2024)',
          ...
          'Otp send to Mobile No':'Otp send to Mobile No',
          'Edit':'Edit',
          'Verify':'Verify',
        ...
        'hi_IN': {
          ...
          'Katha': 'कथा',
          'Basant panchami (Wed, 14 Feb, 2024)':
              'बसंत पंचमी (बुध, 14 फरवरी, 2024)',
          'Shivratri (Fri, 8 Mar, 2024)': 'शिवरात्रि (शुक्र, 8 मार्च, 2024)',
          'Hanuman jayanti (Tue, 23 Apr, 2024)':
              'हनुमान जयंती (मंगल, 23 अप्रैल, 2024)',
          'Nag panchami (Fri, 9 Aug, 2024)': 'नाग पंचमी (शुक्र, 9 अगस्त, 2024)',
          'Rakhsha bandhan (Mon, 19 Aug, 2024)':
              'रक्षा बंधन (सोम, 19 अगस्त, 2024)',
          'Ganesh chaturthi (Sat, 7 Sept, 2024)':
              'गणेश चतुर्थी (शनि, 7 सितंबर, 2024)',
          'Dussehra (Sat, 12 Oct, 2024)': 'दशहरा (शनि, 12 अक्टूबर, 2024)',
          'Karva chauth (Sun, 20 Oct, 2024)':
              'करवा चौथ (रवि, 20 अक्टूबर, 2024)',
          'Ahoi Ashtami (Thu, 24 Oct, 2024)':
              'अहोई अष्टमी (गुरु, 24 अक्टूबर, 2024)',
          ...
          'Otp send to Mobile No':'ओटीपी मोबाइल नंबर पर भेजें',
          'Edit':'संपादन करना',
          'Verify':'सत्यापित करें',
          'Resend Otp in':'ओटीपी दोबारा भेजें',
        }
      };
}
